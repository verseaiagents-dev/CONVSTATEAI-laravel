...
class ProductImageHelper
{
     ...
     * @return string
     */
    public static function getSafeImageUrl(?string $imagePath, string $defaultPath = '/imgs/default-product.jpg'): string
    {
     ...
     * @return string
     */
    public static function getImageWithFallback(?string $imagePath, string $defaultPath = '/imgs/default-product.jpg'): string
    {
        // Eğer resim yolu boş veya null ise default resmi döndür
        if (empty($imagePath) || trim($imagePath) === '') {
            return $defaultPath;
