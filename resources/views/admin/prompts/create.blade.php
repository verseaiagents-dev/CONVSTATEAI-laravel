...
@section('title', 'Yeni Prompt Oluştur - Admin Panel')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-white">Yeni Prompt Oluştur</h1>
            <p class="text-gray-400 mt-2">Yeni bir AI prompt template'i oluşturun</p>
        </div>
    ...
    <div class="bg-gray-800/50 rounded-lg border border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.prompts.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          ...
                          placeholder="Prompt'un ne için kullanıldığını açıklayın">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea id="content" name="content" rows="10" required
                          ...
                          placeholder="Prompt içeriğini buraya yazın. Değişkenler için {variable_name} formatını kullanın.">{{ old('content') }}</textarea>
