...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="glass-effect rounded-2xl p-8 relative overflow-hidden">
            <div
                class="absolute top-0 right-0 w-32 h-32 bg-purple-glow rounded-full mix-blend-multiply filter blur-xl opacity-20">
            </div>
            <div
                class="absolute bottom-0 left-0 w-40 h-40 bg-neon-purple rounded-full mix-blend-multiply filter blur-xl opacity-20">
            </div>
        ...
        <div id="usageModal"
            ...
            <div class="glass-effect rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start space-x-3 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                                <div
                                    class="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-purple-glow to-neon-purple rounded-full flex items-center justify-center text-white font-bold text-sm">
                                    1</div>
                            ...
                            <div class="flex items-start space-x-3 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
                                ...
                                <div class="text-gray-300">
                                    ...
                                    <p class="text-sm">Yukarıdaki embed kodunu <code
                                            class="bg-gray-700 px-2 py-1 rounded text-purple-300">&lt;/head&gt;</code>
                                        etiketinden önce veya <code
                                            class="bg-gray-700 px-2 py-1 rounded text-purple-300">&lt;/body&gt;</code>
                                        etiketinden önce yapıştırın</p>
                                </div>
                            </div>
                        ...
                        <div class="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-yellow-300 text-sm">Bu kodu kopyaladıktan sonra, web sitenizin HTML
                                        dosyasına yapıştırın. Widget'ın çalışması için internet bağlantısı gereklidir.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-300 text-sm">Bu embed kodu localhost gibi yerel alanlarda
                                        çalışmayabilir. Canlı web sitenizde test edin.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-green-300 text-sm">Kodu her sayfada tekrarlamanıza gerek yok, sadece ana
                                        sayfaya eklemeniz yeterlidir. Widget tüm sayfalarda çalışacaktır.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end mt-8">
                    <button id="closeUsageModalBtn"
                        class="px-6 py-3 bg-gradient-to-r from-purple-glow to-neon-purple text-white rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-300">
                        Anladım
                    </button>
                </div>
            </div>
...
&lt;/script&gt;</code></pre>
        ...
        <div id="loadingState" class="glass-effect rounded-2xl p-8">
            <div class="flex flex-col items-center justify-center space-y-6">
                ...
                <div class="relative loading-pulse">
                    ...
                    <div
                        class="absolute top-0 left-0 w-16 h-16 border-4 border-transparent border-t-purple-500 rounded-full animate-spin">
                    </div>
                    <div class="absolute top-0 left-0 w-16 h-16 border-4 border-transparent border-t-neon-purple rounded-full animate-spin"
                        style="animation-delay: -0.5s;"></div>
                    <div class="absolute top-0 left-0 w-16 h-16 border-4 border-transparent border-t-blue-500 rounded-full animate-spin"
                ...
                <div class="w-64 bg-gray-700 rounded-full h-2 overflow-hidden">
                    <div id="progressBar"
                        class="bg-gradient-to-r from-purple-glow to-neon-purple h-2 rounded-full progress-animation"
                        style="width: 0%"></div>
                </div>
            </div>
        </div>
        ...
        <div id="contentContainer" class="hidden space-y-6 slide-in-up">
            ...
            <div class="glass-effect rounded-2xl p-8">
                ...
                <div id="successMessage"
                    class="hidden mb-4 p-3 bg-green-500/20 border border-green-500/30 rounded-lg text-green-400 text-sm">
                    Ayarlar başarıyla kaydedildi!
                </div>

                <!-- Error Message -->
                <div id="errorMessage"
                    class="hidden mb-4 p-3 bg-red-500/20 border border-red-500/30 rounded-lg text-red-400 text-sm">
                    Hata oluştu!
                </div>

                <!-- Test Result Modal -->
                <div id="testResultModal"
                    ...
                    <div class="glass-effect rounded-2xl p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="ai_name" name="ai_name"
                            ...
                            <div>
                                ...
                                <input type="text" id="notification_message" name="notification_message"
                        ...
                        <div>
                            ...
                            <textarea id="welcome_message" name="welcome_message" rows="3"
                                ...
                                class="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 resize-none"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="glass-effect rounded-2xl p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea id="cargo_not_found_message" name="cargo_not_found_message" rows="2"
                            ...
                            <div>
                                <label for="feature_disabled_message"
                                    class="block text-sm font-medium text-gray-300 mb-2">
                                    Özellik Kapalı Mesajı
                                </label>
                                <textarea id="feature_disabled_message" name="feature_disabled_message" rows="2"
                            ...
                            <div>
                                ...
                                <textarea id="error_message_template" name="error_message_template" rows="2"
                            ...
                            <div>
                                ...
                                <textarea id="order_not_found_message" name="order_not_found_message" rows="2"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <input type="text" id="primary_color_text" value="#3B82F6" placeholder="#3B82F6"
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    <input type="color" id="secondary_color" name="secondary_color" value="#6B7280"
                                        class="w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg cursor-pointer">
                                    <input type="text" id="secondary_color_text" value="#6B7280"
                                        placeholder="#6B7280"
                                        class="flex-1 px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    <input type="color" id="theme_color" name="theme_color" value="#3B82F6"
                                        class="w-12 h-12 bg-gray-800 border border-gray-600 rounded-lg cursor-pointer">
                                    <input type="text" id="theme_color_text" value="#3B82F6" placeholder="#3B82F6"
                                        class="flex-1 px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="glass-effect rounded-2xl p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="api_timeout_seconds" name="api_timeout_seconds" min="1"
                                    max="60" value="10"
                                    class="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Typing Indicator -->
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="enable_typing_indicator" name="enable_typing_indicator"
                                    checked
                            ...
                            <!-- Sound Notifications -->
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="enable_sound_notifications" name="enable_sound_notifications"
                                    class="w-5 h-5 text-purple-600 bg-gray-800 border-gray-600 rounded focus:ring-purple-500 focus:ring-2">
                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" id="siparis_active_toggle" name="siparis_active_toggle"
                                            class="sr-only peer">
                                        <div
                            ...
                            <div class="flex space-x-3">
                                ...
                                <input type="text" id="siparis_test_order" name="siparis_test_order"
                                ...
                                <!-- Endpoint URL Input -->
                                <input type="url" id="siparis_durumu_endpoint" name="siparis_durumu_endpoint"
                                    placeholder="https://example.com/api/order-tracking"
                                    class="flex-1 px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200">

                                <!-- Test Button -->
                                <button type="button" id="testSiparisButton" onclick="testEndpoint('siparis')"
                            ...
                            <p class="text-sm text-gray-400 mt-1">
                                Sipariş durumu sorgulama için API endpoint'i. Sol taraftaki alana test sipariş numarası
                                girebilirsiniz.
                            </p>
                        </div>
                    </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex items-center space-x-3">
                                    <span class="text-sm text-gray-400">Aktif:</span>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" id="kargo_active_toggle" name="kargo_active_toggle"
                                            class="sr-only peer">
                                        <div
                                            class="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600">
                                        </div>
                            ...
                            <div class="flex space-x-3">
                                ...
                                <input type="text" id="kargo_test_tracking" name="kargo_test_tracking"
                                    placeholder="TRK789456123"
                                    class="w-48 px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                                    title="Test için kullanılacak tracking number">

                                <!-- Endpoint URL Input -->
                                <input type="url" id="kargo_durumu_endpoint" name="kargo_durumu_endpoint"
                                    placeholder="https://example.com/api/cargo-tracking"
                                    class="flex-1 px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200">

                                <!-- Test Button -->
                                <button type="button" id="testKargoButton" onclick="testEndpoint('kargo')"
                                    class="px-6 py-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-white font-semibold transition-all duration-200 flex items-center space-x-2">
                            ...
                            <p class="text-sm text-gray-400 mt-1">
                                Kargo durumu sorgulama için API endpoint'i. Sol taraftaki alana test tracking number
                                girebilirsiniz.
                            </p>
                        </div>
                    </div>
        ...
        <div id="errorState" class="hidden glass-effect rounded-2xl p-8 fade-in-scale">
            <div class="flex flex-col items-center justify-center space-y-4">
                ...
                <p class="text-gray-400 text-center">Widget ayarları yüklenirken bir hata oluştu. Lütfen sayfayı yenileyin.
                </p>
    ...
    <script>
        ...
        async function loadContent() {
            try {
                ...
                const url = '{{ route('dashboard.widget-design.load-content') }}' + (projectId ?
        ...
        function populateFormFields(data) {
            ...
            if (data.widgetCustomization) {
                ...
                if (customization.enable_sound_notifications !== undefined) {
                    document.getElementById('enable_sound_notifications').checked = customization
        ...
        async function testEndpoint(type) {
            const endpointInput = document.getElementById(type === 'siparis' ? 'siparis_durumu_endpoint' :
            ...
            const buttonSpinner = document.getElementById(type === 'siparis' ? 'testSiparisSpinner' :
                'testKargoSpinner');
            ...
            try {
                ...
                if (result.success) {
                    ...
                    const toggle = document.getElementById(type === 'siparis' ? 'siparis_active_toggle' :
                        'kargo_active_toggle');
                    if (toggle) {
                        toggle.checked = true;
    ...
    `;
        ...
        function toggleEndpointSection(type, isActive) {
            ...
            if (isActive) {
                ...
                if (description) {
                    if (type === 'siparis') {
                        description.textContent =
                            'Sipariş durumu API\'si henüz yapılandırılmamış. Endpoint URL\'i girerek özelliği aktifleştirin.';
                    } else {
                        description.textContent =
                            'Kargo durumu API\'si henüz yapılandırılmamış. Endpoint URL\'i girerek özelliği aktifleştirin.';
                    }
                }
            }
        }
                ...
                copyEmbedScriptBtn.addEventListener('click', function() {
                    ...
                    if (embedScript) {
                        navigator.clipboard.writeText(embedScript).then(function() {
                            ...
                            const originalText = copyEmbedScriptBtn.querySelector('span')
                                .textContent;
                            ...
                            copyEmbedScriptBtn.classList.remove('from-purple-glow',
                                'to-neon-purple', 'hover:from-purple-600', 'hover:to-purple-700'
                                );

                            // Reset after 2 seconds
                            setTimeout(function() {
                                copyEmbedScriptBtn.querySelector('span').textContent =
                                    originalText;
                                copyEmbedScriptBtn.classList.remove('bg-green-600',
                                    'hover:bg-green-700');
                                copyEmbedScriptBtn.classList.add('from-purple-glow',
                                    'to-neon-purple', 'hover:from-purple-600',
                                    'hover:to-purple-700');
                            }, 2000);
                        }).catch(function(err) {
            ...
            if (copyApiJsonBtn) {
                copyApiJsonBtn.addEventListener('click', function() {
                    ...
                    navigator.clipboard.writeText(jsonContent).then(function() {
                        ...
                        copyApiJsonBtn.classList.remove('from-purple-glow', 'to-neon-purple',
                            'hover:from-purple-600', 'hover:to-purple-700');

                        setTimeout(function() {
                            copyApiJsonBtn.querySelector('span').textContent = originalText;
                            copyApiJsonBtn.classList.remove('bg-green-600',
                                'hover:bg-green-700');
                            copyApiJsonBtn.classList.add('from-purple-glow',
                                'to-neon-purple', 'hover:from-purple-600',
                                'hover:to-purple-700');
                        }, 2000);
                    }).catch(function(err) {
        ...
        window.showApiExampleModal = function(type) {
            ...
            if (type === 'siparis') {
                ...
                apiUsageInfo.textContent =
                    'Sipariş durumu sorgulama API endpoint\'i için örnek JSON yapısı. Bu yapıyı kullanarak API\'nizi test edebilirsiniz.';
                apiJsonExample.textContent = window.getSiparisApiExample();
            } else if (type === 'kargo') {
                modalTitle.textContent = 'Kargo Durumu API JSON Örneği';
                apiUsageInfo.textContent =
                    'Kargo durumu sorgulama API endpoint\'i için örnek JSON yapısı. Bu yapıyı kullanarak API\'nizi test edebilirsiniz.';
