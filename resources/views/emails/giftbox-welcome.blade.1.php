...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="message">
                Sizin {{ $sectorName }} sektörünüze özel olarak hazırladığımız ücretsiz kitapçık hazırlıyoruz. Yakında e-posta kutunuza göndereceğiz.
            </p>

            <!-- <a href="{{ $downloadUrl }}" class="download-button">Şimdi İndir</a> -->
        </div>
