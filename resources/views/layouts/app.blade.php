...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img src="{{ asset('imgs/ai-conversion-logo.svg') }}" alt="ConvStateAI Logo" class="w-10 h-10">
                        <span class="ml-3 text-xl font-bold text-gray-900 dark:text-white">ConvStateAI</span>
                    </a>
                </div>
                
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 px-3 py-2 rounded-md text-sm font-medium">
                        Giriş Yap
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400 text-sm">
                        E-ticaret siteniz için AI destekli chat widget çözümleri.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#features" class="hover:text-purple-400 transition-colors">Özellikler</a></li>
                        <li><a href="#pricing" class="hover:text-purple-400 transition-colors">Fiyatlandırma</a></li>
                        <li><a href="#demo" class="hover:text-purple-400 transition-colors">Demo</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="{{ route('privacy-policy') }}" class="hover:text-purple-400 transition-colors">Gizlilik Politikası</a></li>
                        <li><a href="{{ route('terms-of-service') }}" class="hover:text-purple-400 transition-colors">Kullanım Şartları</a></li>
                        <li><a href="{{ route('cookies') }}" class="hover:text-purple-400 transition-colors">Çerez Politikası</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="mailto:support@convstateai.com" class="hover:text-purple-400 transition-colors">İletişim</a></li>
                        <li><a href="#" class="hover:text-purple-400 transition-colors">Yardım Merkezi</a></li>
                        <li><a href="#" class="hover:text-purple-400 transition-colors">API Dokümantasyonu</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-50 md:hidden">
        <div class="grid grid-cols-4 h-16">
            ...
            <a href="{{ route('subscription.plans') }}" class="flex flex-col items-center justify-center space-y-1 text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors {{ request()->routeIs('subscription.plans*') ? 'text-purple-600 dark:text-purple-400' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
